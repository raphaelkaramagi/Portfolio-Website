...
function CarouselTile({ item, tabHidden = false }) {
  return (
    <Link
      ...
      className={`carousel-tile group relative block shrink-0 h-40 sm:h-52 w-[min(72vw,18rem)] sm:w-[min(42vw,22rem)] overflow-hidden rounded-2xl ring-1 ring-overlay/10 shadow-[0_18px_44px_-18px_rgba(0,0,0,0.45)] transition-[transform,box-shadow,ring-color] duration-300 hover:scale-[1.02] hover:ring-brand-red/35 hover:shadow-[0_24px_56px_-18px_rgba(220,38,38,0.25)] ${focusRing}`}
    >
      <img
        src={item.preview}
        alt=""
...
export default function ProjectCarousel() {
  ...
  return (
    ...
    >
      <div className="carousel-viewport mx-auto max-w-[100vw]">
        <div
