export const projects = [
  {
    ...
    images: ['/projects/asl/asl1.png', '/projects/asl/asl2.png', '/projects/asl/asl3.png'],
  },
  {
    number: '02',
    ...
    images: ['/projects/portfolio/portfolio1.png', '/projects/portfolio/portfolio2.png', '/projects/portfolio/portfolio3.png', '/projects/portfolio/portfolio4.png'],
  },
  {
    number: '03',
  ...
  },
  {
    ...
    description:
      'An Arduino-controlled solenoid valve system automating pressure-washer timing for a commercial composting facility — MOSFET-driven actuation, timed wash cycles, and hardware safety interlocks.',
    longDescription:
      'A client project for Compost Now, a Raleigh-based composting company whose workers were manually timing bin washes with a pressure washer and hydraulic lift — leading to water waste and inconsistent cleans.\n\nThe control system centers on an Arduino Nano driving a 12V solenoid valve through a MOSFET switching circuit with a flyback diode for back-EMF protection. The solenoid is plumbed in series with the existing manual ball valve, so the system fails safe — if the electronics lose power or malfunction, operators revert to manual control through the normally-open valve path. A 12V-to-5V buck regulator powers the logic side from the same supply.\n\nThe operator interface is housed in a NEMA-rated enclosure with debounced push buttons for selecting wash durations (30, 60, or 90 seconds), LED status indicators, and an amber warning beacon. A hardware emergency-stop button immediately de-energizes the solenoid, cutting flow regardless of firmware state. All connections are hand-soldered to a perfboard with screw terminals for field serviceability.\n\nThe project spans embedded C++ firmware, circuit design and prototyping, PCB soldering, CAD enclosure modeling, and on-site integration with existing plumbing and hydraulic infrastructure.',
    repoUrl: '',
    images: [
      '/projects/compost-bin/compost1.jpeg',
      '/projects/compost-bin/compost2.jpeg',
      '/projects/compost-bin/compost3.jpeg',
      '/projects/compost-bin/compost4.jpeg',
      '/projects/compost-bin/compost5.jpeg',
      '/projects/compost-bin/compost6.jpeg',
    ],
  },
  {
    number: '05',
  ...
  },
  {
    ...
    description:
      'Security scanning and evaluation tooling for locally deployed AI models — summer internship project with Duke OIT.',
    longDescription:
      'A summer contract project with Duke\'s Office of Information Technology. Building automated security scanning for AI model artifacts and an LLM evaluation framework for benchmarking models across task categories.\n\nMore details will be added as the project takes shape.',
    repoUrl: '',
    images: [],
  },
  {
